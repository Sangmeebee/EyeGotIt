...
public class CsrProc implements SpeechRecognitionListener {
    ...
    public void onInactive() {
        ...
        Message msg = Message.obtain(mHandler, 6);
        msg.sendToTarget();
    }
    ...
    public void onRecord(short[] speech) {
        ...
        Message msg = Message.obtain(mHandler, 2, speech);
        msg.sendToTarget();
    }
    ...
    public void onResult(SpeechRecognitionResult result) {
        ...
        Message msg = Message.obtain(mHandler, 4, result);
        msg.sendToTarget();
    }
    ...
    public void onError(int errorCode) {
        ...
        Message msg = Message.obtain(mHandler, 5, errorCode);
        msg.sendToTarget();
    }
    ...
    public void onEndPointDetectTypeSelected(EndPointDetectType epdType) {
        ...
        Message msg = Message.obtain(mHandler, 7, epdType);
        msg.sendToTarget();
    }
}